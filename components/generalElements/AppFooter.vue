    ...
    >
      ...
      <div class="w-3/7 lg:w-auto">
        ...
        <div class="text-sm">
          ...
          <NuxtLink to="/wishlist" class="py-1.5 block">{{
            $t("messages.shop.wishlist")
          }}</NuxtLink>
          <a href="/" class="py-1.5 block">{{
    ...
    <div class="container border-t flex items-center justify-center mb-4">
      <div class="copywrite">
        <p class="py-4 text-xs text-center">
          ...
          - by
          <a
            href="https://github.com/devbipu"
            title="Biplob Shaha - Full Stack Web Developer"
            target="_blank"
          >
            Biplob Shaha
          </a>
